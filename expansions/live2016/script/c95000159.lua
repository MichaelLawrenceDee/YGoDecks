...
function c95000159.initial_effect(c)
	...
	e5:SetValue(c95000159.aclimit)
	c:RegisterEffect(e5)
	--~ Add Action Card
	local e6=Effect.CreateEffect(c)
	e6:SetDescription(aux.Stringid(95000159,0))
	e6:SetType(EFFECT_TYPE_QUICK_O)
	e6:SetRange(LOCATION_SZONE)
	e6:SetCode(EVENT_FREE_CHAIN)
	e6:SetCondition(c95000159.condition)
	e6:SetTarget(c95000159.Acttarget)
	e6:SetOperation(c95000159.operation)
	c:RegisterEffect(e6)
	--cannot change zone
...
function c95000159.aclimit(e,re,tp)
