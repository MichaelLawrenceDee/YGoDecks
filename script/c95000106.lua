...
function c95000106.initial_effect(c)
	...
	e5:SetValue(c95000106.aclimit)
	c:RegisterEffect(e5)
	--~ Add Action Card
	local e6=Effect.CreateEffect(c)
	e6:SetDescription(aux.Stringid(95000106,0))
	e6:SetType(EFFECT_TYPE_QUICK_O)
	e6:SetRange(LOCATION_SZONE)
	e6:SetCode(EVENT_FREE_CHAIN)
	e6:SetCondition(c95000106.condition)
	e6:SetTarget(c95000106.Acttarget)
	e6:SetOperation(c95000106.operation)
	c:RegisterEffect(e6)
	--atk
	local e6=Effect.CreateEffect(c)
...
function c95000106.aclimit(e,re,tp)
