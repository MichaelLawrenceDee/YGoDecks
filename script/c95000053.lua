...
function c95000053.initial_effect(c)
	...
	e4:SetTarget(c95000053.aclimit2)
	c:RegisterEffect(e4)
	--cannot activate
	...
	e5:SetValue(c95000053.aclimit)
	c:RegisterEffect(e5)
	--~ Add Action Card
	local e6=Effect.CreateEffect(c)
	e6:SetDescription(aux.Stringid(95000053,0))
	e6:SetType(EFFECT_TYPE_QUICK_O)
	e6:SetRange(LOCATION_SZONE)
	e6:SetCode(EVENT_FREE_CHAIN)
	e6:SetCondition(c95000053.condition)
	e6:SetTarget(c95000053.Acttarget)
	e6:SetOperation(c95000053.operation)
	c:RegisterEffect(e6)
	--cannot change zone
...
function c95000053.aclimit(e,re,tp)
...
e:GetHandler():RegisterFlagEffect(95000053,RESET_EVENT+0x1fe0000+RESET_PHASE+PHASE_END,0,1)
end
...
function c95000053.condition(e,tp,eg,ep,ev,re,r,rp)
	return not Duel.IsExistingMatchingCard(c95000053.cfilter,tp,LOCATION_SZONE+LOCATION_HAND,0,1,nil) and e:GetHandler():GetFlagEffect(95000053)==0
