...
function c511000044.filter(c,tp)
	return c:IsType(TYPE_TOKEN) 
		and Duel.IsPlayerCanSpecialSummonMonster(1-tp,500000148,0,0x4011,c:GetBaseAttack(),c:GetBaseDefence(),
...
function c511000044.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	if Duel.GetLocationCount(1-tp,LOCATION_MZONE)<=0
		or not Duel.IsPlayerCanSpecialSummonMonster(1-tp,500000148,0,0x4011,tc:GetBaseAttack(),tc:GetBaseDefence(),
